...
public class IndexedModel {
	...
	public void CalcNormals() {
		for (int i = 0; i < m_indices.size(); i += 3) {
			final int i0 = m_indices.get(i);
			final int i1 = m_indices.get(i + 1);
			final int i2 = m_indices.get(i + 2);

			final Vector3f v1 = m_positions.get(i1).Sub(m_positions.get(i0));
			final Vector3f v2 = m_positions.get(i2).Sub(m_positions.get(i0));
	...
	public void CalcTangents() {
		for (int i = 0; i < m_indices.size(); i += 3) {
			...
			final Vector3f edge1 = m_positions.get(i1).Sub(m_positions.get(i0));
			final Vector3f edge2 = m_positions.get(i2).Sub(m_positions.get(i0));

			final float deltaU1 = m_texCoords.get(i1).GetX() - m_texCoords.get(i0).GetX();
			final float deltaV1 = m_texCoords.get(i1).GetY() - m_texCoords.get(i0).GetY();
			final float deltaU2 = m_texCoords.get(i2).GetX() - m_texCoords.get(i0).GetX();
			final float deltaV2 = m_texCoords.get(i2).GetY() - m_texCoords.get(i0).GetY();
